...
Feature: ViceDean ogretmen kaydi olusturabilmeli
  ...
  @08 @busra @US13T2
  Scenario: TCO2_Vice Dean öğretmen kaydı oluştururken ders seçmeden kayıt edilememeli
  #Negatif Senaryo
  ...
  @08 @busra @US13T3
  Scenario: TCO3_Vice Dean öğretmen kaydı oluştururken ders seçmeden kayıt edilememeli
  #Negatif Senaryo
  ...
  @08 @busra @US13T4
  Scenario: TCO4_Vice Dean öğretmen kaydı oluştururken Surname alanı doldurulmadan kayıt edilememeli
  #Negatif Senaryo
  ...
  @08 @busra @US13T5
  Scenario: TCO5_Vice Dean öğretmen kaydı oluştururken Birth Place alanı doldurulmadan kayıt edilememeli
  #Negatif Senaryo
  ...
  @08 @busra @US13T6
  Scenario: TCO6_Vice Dean öğretmen kaydı oluştururken Email alanı doldurulmadan kayıt edilememeli
  #Negatif Senaryo
  ...
  @08 @busra @US13T7
  Scenario: TCO7_Vice Dean öğretmen kaydı oluştururken Phone alanı doldurulmadan kayıt edilememeli
  #Negatif Senaryo
  ...
  @08 @busra @US13T8
  Scenario: TCO8_Vice Dean öğretmen kaydı oluştururken Gender alanı doldurulmadan kayıt edilememeli
  #Negatif Senaryo
  ...
  @08 @busra @US13T9
  Scenario: TCO9_Vice Dean öğretmen kaydı oluştururken Date Of Birth alanı doldurulmadan kayıt edilememeli
  #Negatif Senaryo
  ...
  @08 @busra @US13T10
  Scenario: TC10_Vice Dean öğretmen kaydı oluştururken SSN alanı doldurulmadan kayıt edilememeli
  #Negatif Senaryo
  ...
  @08 @busra @US13T11
  Scenario: TC11_Vice Dean öğretmen kaydı oluştururken SSN; 3. ve 5. rakamdan sonra "-" içermeden girilen 9 rakamla kayıt edilememeli
  #Negatif Senaryo
  ...
  @08 @busra @US13T12
  Scenario: TC12_Vice Dean öğretmen kaydı oluştururken User Name alanı doldurulmadan kayıt edilememeli
  #Negatif Senaryo
  ...
  @08 @busra @US13T13
  Scenario: TC13_Vice Dean öğretmen kaydı oluştururken Password en az 8 karakterden oluşmalı
  #Negatif Senaryo
  ...
  @08 @busra @US13T14
  Scenario: TC14_Vice Dean öğretmen kaydı oluştururken Password küçük harf içermeli ve en az 8 karakterden oluşmalı
  #Negatif Senaryo
  ...
  @08 @busra @US13T15
  Scenario: TC15_Vice Dean öğretmen kaydı oluştururken Password küçük harf, büyük harf içermeli ve en az 8 karakterden oluşmalı
  #Negatif Senaryo
